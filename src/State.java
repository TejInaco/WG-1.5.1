...
public class State implements Cloneable {
  ...
  public ArrayList<Integer> getLegalActions() {
    ...
    for (int j = 0; j < this.cols; j++) if (this.board[0][j] == '.') actions.add(j);
    return actions;
  }
  ...
  public int central(char agent) {
    ...
    public int nlinhas4(char agent) {
        ...
        String findRigth = "" + agent + "" + agent + "" + agent + "" + agent; // 000.
        ...
        int colCounter = counter - lineCounter;
        // check diagonals
        ArrayList<Point> pos_right = new ArrayList<Point>();
        ArrayList<Point> pos_left = new ArrayList<Point>();
        ...
        int diagCounter = counter - lineCounter - colCounter;
  ...
  public int nlinhas2(char agent) {
    ...
    System.out.println("For colunas 2: " + counter);
    ...
    int diagCounter = counter - lineCounter - colCounter;
    System.out.println("diagCounter 2: " + diagCounter);
    System.out.println("total counter 2: " + counter);
