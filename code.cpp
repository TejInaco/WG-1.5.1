...
move get_human_mov(state st);
move get_pc_rand_mov(state st);
move get_pc_greedy_mov(state st);
bool valid_movement(state st, move mov);
state execute_movement(state st, move mov);
